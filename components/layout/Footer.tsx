...
const FOOTER_COLUMNS = [
  ...
  },
  {
    title: "Quick Links",
    links: [
      { label: "Find a Plumber", href: "/find-plumber" },
      ...
      <div className="container-pg pt-14 pb-8">
              ...
              <ul className="space-y-2.5">
                {col.links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-gray-300 hover:text-[#F97316] transition-colors"
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500 text-center sm:text-left">
            © {new Date().getFullYear()} Plumber Guru. All rights reserved. |{" "}
            <span className="text-gray-600">plumber-guru.com</span>
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://youtube.com/@plumberguru"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
